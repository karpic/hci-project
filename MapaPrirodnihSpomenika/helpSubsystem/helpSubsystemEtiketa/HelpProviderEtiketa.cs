...
namespace MapaPrirodnihSpomenika.helpSubsystem.helpSubsystemEtiketa
{
    class HelpProviderEtiketa
    {
        ...
        public static readonly DependencyProperty HelpKeyProperty =
            DependencyProperty.RegisterAttached("HelpKeyEtiketa", typeof(string), typeof(HelpProvider), new PropertyMetadata("index", HelpKey));
        private static void HelpKey(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            //NOOP
        }

        public static void ShowHelp(string key, IzmenaTag originator)
        {
            HelpViewerEtiketa hh = new HelpViewerEtiketa(key, originator);
            hh.Show();
        }
    }
}
